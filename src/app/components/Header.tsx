      ...
      <div class="max-w-5xl mx-auto flex flex-wrap p-5 flex-col md:flex-row">
        ...
        >
          <div class="md:ml-auto md:mr-auto font-4 pt-1 md:pl-14 pl-1 flex flex-wrap items-center md:text-base text-1xl md:justify-center justify-items-start">
            ...
            <nav>
            <Link
                href="/articles" class="mr-12 md:ml-11 ml-0 cursor-pointer text-gray-300 hover:text-white font-semibold tr04">
              Articles
            </Link>

            <Link
                href="/dashboard" class="mr-5 cursor-pointer text-gray-300 hover:text-white font-semibold tr04">
              Dashboard
            </Link>
            </nav>
          </div>
